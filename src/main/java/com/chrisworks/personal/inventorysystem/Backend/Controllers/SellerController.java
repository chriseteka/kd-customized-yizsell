...
////
////        List<Seller> fetchAllWarehouseAttendantByWarehouseId = sellerServices.fetchAllWarehouseAttendantByWarehouseId();
////
////        return (fetchAllWarehouseAttendantByWarehouseId != null && !fetchAllWarehouseAttendantByWarehouseId.isEmpty()) ? ResponseEntity.ok(fetchAllWarehouseAttendantByWarehouseId) : ResponseEntity.notFound().build();
////    }
//}
