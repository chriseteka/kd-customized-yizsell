 ...
 */
@Component
public class WeeklyJobs {

    private static final long JOB_FIXED_RATE_TIME = 1000L * 60L * 60L * 24L * 7L; //Seven days in millis.
    ...
    public WeeklyJobs(BusinessOwnerRepository businessOwnerRepository, MailServices mailServices,
    ...
    private void sendDailySummaryToBusinessOwners(){
        ...
        String notice = "Weekly Reports Summary";
